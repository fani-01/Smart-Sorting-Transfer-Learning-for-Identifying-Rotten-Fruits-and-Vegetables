...
app = Flask(__name__)
model = tf.keras.models.load_model('healthy_vs_rotten.h5')  # Make sure this file exists
...
def output():
    if request.method == 'POST':
        ...
        class_names = ['Apple_Healthy (0)', 'Apple_Rotten (1)', 'Banana_Healthy (2)', 'Banana_Rotten (3)',
...
@app.route('/about')
def about():
    return render_template("about.html")  # Fixed this line
